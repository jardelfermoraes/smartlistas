      ...
      >
        ...
        >
          {navSections.map((section, sectionIdx) => (
            ...
            >
              <div className="mb-2 text-[11px] font-semibold text-gray-400 uppercase tracking-wider">
                {section.title}
              </div>
              {section.items.map((item) => {
                ...
                return (
                  <Link
                    ...
                    className={`group flex items-center gap-2 px-3 py-2.5 mb-1 rounded-lg text-sm font-medium transition-colors ${
                      isActive
